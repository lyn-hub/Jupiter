...
public class MySQLTableCreator { //schema, create table
    public static void main(String[] args) {
        try {
            ...
            String sql = "DROP TABLE IF EXISTS favorite_records"; //delete the table contains the FK
            ...
            sql = "CREATE TABLE items ("
                    + "id VARCHAR(255) NOT NULL,"// VARCHAR : string
                    + "title VARCHAR(255),"
                    + "url VARCHAR(255),"
